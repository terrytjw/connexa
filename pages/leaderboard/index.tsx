...
import { collectionGroup, getFirestore, getDocs, query, orderBy } from "firebase/firestore";
...
const Leaderboard = ({  usernames }: Props) => {
  ...
  <div className="grow-[5.5]">
          <h1 className="mb-10 text-5xl font-bold pt-20 text-center">Leaderboard</h1>

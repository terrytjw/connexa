  ...
  return (
    <div className="flex flex-col w-5/12 h-max border border-black rounded-2xl p-5">
      <div className="top-row flex items-center justify-between mb-2">
        ...
        <div className="save-button rounded-full p-2 bg-blue-100 ml-3">
          <svg
      ...
      <div className="comments-section flex flex-col">
        <div className="comment flex items-center p-3 bg-gray-100 justify-between rounded-xl mb-3">
          <div className="img w-9 h-9 rounded-full overflow-hidden mr-3">
            <Image src={img} />
          </div>
          <div className="comment-content flex flex-col mr-auto">
            <div className="name font-bold text-sm">John Smith</div>
            <div className="message text-sm">Thanks for sharing!</div>
          </div>
